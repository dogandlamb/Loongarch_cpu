# Short VCD run focused on ROB commit / INE probes (single 20us slice)
set ::VCD_SCOPE "/tb_top/u_soc_top/u_cpu/*"
set ::VCD_RUN_ONCE_US 20
set ::VCD_FILE [file normalize [file dirname [info script]]/project/tb_top_rob.vcd]
