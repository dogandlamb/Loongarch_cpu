...
proc snap {label} {
    ...
    catch { puts "  rs0=[get_value $cpu/u_rs_alu0/occupancy_o] rs1=[get_value $cpu/u_rs_alu1/occupancy_o] rsm=[get_value $cpu/u_rs_mem/occupancy_o]" }
    catch { puts "  rob_full=[get_value $cpu/u_rob/rob_full_o] head_v=[get_value $cpu/u_rob/cmt0_valid_o] head_c=[get_value $cpu/u_rob/cmt0_complete_o] head_last=[get_value $cpu/u_rob/cmt0_is_last_o]" }
}
