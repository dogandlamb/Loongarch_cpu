...
* 传输协议选择Xmodem Send
* 打开文件选择下载的[gitee.com/chenzes/chiplab-tools/releases/download/pmon/gzrom.bin](https://gitee.com/chenzes/chiplab-tools/releases/download/pmon/gzrom.bin)这个bin文件
* 剩下设置保持默认不变
