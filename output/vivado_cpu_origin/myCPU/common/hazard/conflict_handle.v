...
// 4-state safe: == with X propagates X into RAW_hazard/stall/block_sig.
...
// Stall on load-use hazards from EXE or MEM stage.
// EXE-stage load: data not available yet.
// MEM-stage pending load: data may still be waiting on memory return.
