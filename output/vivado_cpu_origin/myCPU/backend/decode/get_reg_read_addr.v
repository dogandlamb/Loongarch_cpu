// ============================================================
// get_reg_read_addr: generate regfile read addresses for ID.
// Most instructions read rj on port1 and rk/rd on port2.
// CSR instructions are special:
// - csrwr reads its GPR operand from rd
// - csrxchg reads mask from rj and data from rd
// ============================================================
