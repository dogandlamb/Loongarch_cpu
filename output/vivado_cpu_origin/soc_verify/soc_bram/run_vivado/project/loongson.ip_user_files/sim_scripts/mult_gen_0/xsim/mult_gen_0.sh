...
#
# Script generated by Vivado on Tue Mar 31 20:23:58 +0800 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_gen_0 xil_defaultlib.mult_gen_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/vivado/Vivado/2023.2/data/xsim"
  fi
