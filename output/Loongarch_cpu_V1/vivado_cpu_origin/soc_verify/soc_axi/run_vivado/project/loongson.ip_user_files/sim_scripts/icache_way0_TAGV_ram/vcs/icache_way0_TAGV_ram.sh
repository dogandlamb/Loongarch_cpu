...
#
# Script generated by Vivado on Fri May 08 20:59:45 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : icache_way0_TAGV_ram.sh
...
#
# Usage        : icache_way0_TAGV_ram.sh
#                icache_way0_TAGV_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                icache_way0_TAGV_ram.sh [-reset_run]
#                icache_way0_TAGV_ram.sh [-reset_log]
#                icache_way0_TAGV_ram.sh [-help]
#
...
#                script (type 'icache_way0_TAGV_ram.sh -help' for more information).
#
...
# script info
echo -e "icache_way0_TAGV_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./icache_way0_TAGV_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.icache_way0_TAGV_ram xil_defaultlib.glbl -o icache_way0_TAGV_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./icache_way0_TAGV_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key icache_way0_TAGV_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc icache_way0_TAGV_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./icache_way0_TAGV_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: icache_way0_TAGV_ram.sh [-help]\n\
Usage: icache_way0_TAGV_ram.sh [-step]\n\
Usage: icache_way0_TAGV_ram.sh [-lib_map_path]\n\
Usage: icache_way0_TAGV_ram.sh [-reset_run]\n\
Usage: icache_way0_TAGV_ram.sh [-reset_log]\n\
Usage: icache_way0_TAGV_ram.sh [-keep_index]\n\
Usage: icache_way0_TAGV_ram.sh [-noclean_files]\n\n\
