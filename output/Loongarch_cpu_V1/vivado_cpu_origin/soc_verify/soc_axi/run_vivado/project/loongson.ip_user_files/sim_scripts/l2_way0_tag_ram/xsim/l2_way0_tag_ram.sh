...
#
# Script generated by Vivado on Fri May 08 20:56:37 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : l2_way0_tag_ram.sh
...
#
# Usage        : l2_way0_tag_ram.sh
#                l2_way0_tag_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                l2_way0_tag_ram.sh [-reset_run]
#                l2_way0_tag_ram.sh [-reset_log]
#                l2_way0_tag_ram.sh [-help]
#
...
# script info
echo -e "l2_way0_tag_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./l2_way0_tag_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot l2_way0_tag_ram xil_defaultlib.l2_way0_tag_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim l2_way0_tag_ram -key {Behavioral:sim_1:Functional:l2_way0_tag_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb l2_way0_tag_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./l2_way0_tag_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: l2_way0_tag_ram.sh [-help]\n\
Usage: l2_way0_tag_ram.sh [-step]\n\
Usage: l2_way0_tag_ram.sh [-lib_map_path]\n\
Usage: l2_way0_tag_ram.sh [-reset_run]\n\
Usage: l2_way0_tag_ram.sh [-reset_log]\n\
Usage: l2_way0_tag_ram.sh [-keep_index]\n\
Usage: l2_way0_tag_ram.sh [-noclean_files]\n\n\
