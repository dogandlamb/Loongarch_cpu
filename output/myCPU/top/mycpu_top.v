...
module mycpu_top(
    ...
    wire         l2_mem_rd_rdy;
    wire         l2_mem_ret_valid;
    wire         l2_mem_ret_last;
    wire [127:0] l2_mem_ret_data;
    wire         l2_mem_wr_req;
    ...
    l2cache u_l2cache (
        ...
        .dc_wr_cacop   (axi_dc_wr_cacop),
        .dc_wr_rdy     (axi_dc_wr_rdy),
        .mem_rd_req    (l2_mem_rd_req),
        .mem_rd_type   (l2_mem_rd_type),
        .mem_rd_addr   (l2_mem_rd_addr),
        .mem_rd_rdy    (l2_mem_rd_rdy),
        .mem_ret_valid (l2_mem_ret_valid),
        .mem_ret_last  (l2_mem_ret_last),
        .mem_ret_data  (l2_mem_ret_data),
    ...
    axi_line_bridge u_axi_line_bridge (
        ...
        .dc_rd_rdy     (l2_mem_rd_rdy),
        .dc_ret_valid  (l2_mem_ret_valid),
        .dc_ret_last   (l2_mem_ret_last),
        .dc_ret_data   (l2_mem_ret_data),
