...
design_libs=(xpm jtag_axi xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/e2ba/hdl/verilog" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/a29c/hdl/verilog" \
  ...
  vlogan -work jtag_axi $vlogan_opts +v2k +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/e2ba/hdl/verilog" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/a29c/hdl/verilog" \
  "../../../ipstatic/gen/b140/hdl/jtag_axi_v1_2_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/e2ba/hdl/verilog" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/a29c/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.jtag_axi xil_defaultlib.glbl -o jtag_axi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./jtag_axi_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key jtag_axi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc jtag_axi_simv.daidir vcs_lib c.obj)
