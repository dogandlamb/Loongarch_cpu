...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/gen/c2c6" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/clk_pll_ddr/gen/gen/c2c6" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/gen/c2c6" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/clk_pll_ddr/gen/gen/c2c6" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_pll_ddr xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_pll_ddr -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_pll_ddr_sc.so .tmp_log xcelium_lib waves.shm c.obj)
