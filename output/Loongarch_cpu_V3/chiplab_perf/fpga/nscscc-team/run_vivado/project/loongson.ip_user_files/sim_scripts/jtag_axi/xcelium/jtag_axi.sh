...
#
# Script generated by Vivado on Tue Aug 18 21:11:44 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : jtag_axi.sh
...
#
# Usage        : jtag_axi.sh
#                jtag_axi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                jtag_axi.sh [-reset_run]
#                jtag_axi.sh [-reset_log]
#                jtag_axi.sh [-help]
#
...
#                script (type 'jtag_axi.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname jtag_axi -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm jtag_axi xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "jtag_axi.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./jtag_axi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/e2ba/hdl/verilog" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/a29c/hdl/verilog" \
  ...
  xmvlog -work jtag_axi $xmvlog_opts +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/e2ba/hdl/verilog" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/a29c/hdl/verilog" \
  "../../../ipstatic/gen/b140/hdl/jtag_axi_v1_2_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/e2ba/hdl/verilog" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/jtag_axi/gen/gen/a29c/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.jtag_axi xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.jtag_axi -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log jtag_axi_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./jtag_axi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: jtag_axi.sh [-help]\n\
Usage: jtag_axi.sh [-step]\n\
Usage: jtag_axi.sh [-lib_map_path]\n\
Usage: jtag_axi.sh [-reset_run]\n\
Usage: jtag_axi.sh [-reset_log]\n\
Usage: jtag_axi.sh [-keep_index]\n\
Usage: jtag_axi.sh [-noclean_files]\n\n\
