...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L jtag_axi -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot jtag_axi xil_defaultlib.jtag_axi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim jtag_axi -key {Behavioral:sim_1:Functional:jtag_axi} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb jtag_axi.wdb xsim.dir libdpi.so)
