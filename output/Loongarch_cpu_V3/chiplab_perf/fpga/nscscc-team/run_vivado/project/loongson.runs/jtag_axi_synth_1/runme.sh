...
HD_PWD='C:/Users/h546d/Desktop/zzz/chiplab/fpga/nscscc-team/run_vivado/project/loongson.runs/jtag_axi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jtag_axi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jtag_axi.tcl
