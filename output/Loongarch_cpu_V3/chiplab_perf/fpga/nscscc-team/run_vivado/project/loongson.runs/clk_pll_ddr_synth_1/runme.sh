...
HD_PWD='C:/Users/h546d/Desktop/zzz/chiplab/fpga/nscscc-team/run_vivado/project/loongson.runs/clk_pll_ddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_pll_ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_pll_ddr.tcl
